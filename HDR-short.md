...
4. **Right to Meaningful Consent for Data Use**  
   - Data collection, tracking, AI training, and profiling require explicit, informed, *opt-in* consent.  
   - Consent must be revocable without penalty.  
   - **Any data retention must also be opt-in, clearly disclosed, and limited to reasonable timeframes.**
...
8. **Right to Protection from Deceptive Practices**  
   ...
   - Users must be protected from systems that automatically opt them into harmful or limiting settings.
