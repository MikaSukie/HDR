...
## Preamble
Digital life is real life. Ownership, consent, privacy, and fairness must apply online as they do offline.
...
## Key Reforms
- **Constrained Recommendations:** Default mode recommends based on explicit watch history and closely related creators/topics, not by escalating intensity to maximize session length. Broader discovery must be opt-in.  
- **Ad Limits:** Behavioral profiling ads require opt-in; contextual ads (content-relevant, not psychologically inferred) are permitted. Exploitative attention-baiting (e.g., sexualized “thirst-trap” targeting) is banned or restricted. Every ad must include a simple “why this ad?” label and one-click opt-out.  
- **Restore Friction:** UI and design must make leaving sessions and setting limits easy (timers, summaries, clear exit affordances).  
...
- Default “Constrained Recommendations” for new users and minors.  
- Creator-first discovery channels and human curation to support small creators.  
- Public algorithmic transparency (high-level ranking signals) and one-click ad explanation/opt-out.  
- Remedies and scaled penalties for willful violations; fund public-interest implementations and audits.
